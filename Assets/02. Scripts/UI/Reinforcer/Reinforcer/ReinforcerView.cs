...
public class ReinforcerView : MonoBehaviour, IReinforcerView
{
    [Header("UI 관련 컴포넌트")]
    [Header("캔버스 그룹")]
    ...
    private ReinforcerPresenter m_presenter;
    ...
    public IReinforcerSlotView InstantiateSlot()
    {
        var slot_obj = Instantiate(m_slot_prefab, m_slot_root);

        return slot_obj.GetComponent<IReinforcerSlotView>();
    }
